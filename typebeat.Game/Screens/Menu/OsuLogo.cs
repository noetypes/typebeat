...
{
    /// <summary>
    /// type!beat logo and its attachments (pulsing, visualiser etc.)
    /// </summary>
    public partial class OsuLogo : BeatSyncedContainer
    {
        ...
        /// <summary>
        /// The type!beat logo sprite has a shadow included in its texture.
                                                        ...
                                                        logoContainer = new CircularContainer
                                                        {
                                                            ...
                                                            Children = new Drawable[]
                                                            {
                                                                colourAndTriangles = new Container
                                                                {
                                                                    ...
                                                                    Children = new Drawable[]
                                                                    {
                                                                        // type!beat: the cookie was osu's pink; it is now a charcoal surface (website
                                                                        // --surface-2 → --bg) so the white ring/lettering pop, with the lime accent
                                                                        // carried by the visualiser bars behind it instead of the fill.
                                                                        new Box
                                                                        {
                                                                            RelativeSizeAxes = Axes.Both,
                                                                            Colour = ColourInfo.GradientVertical(Color4Extensions.FromHex(@"1f2027"), Color4Extensions.FromHex(@"141519")),
                                                                        },
                                                                        triangles = new TrianglesV2
                                                                        {
                                                                            ...
                                                                            ScaleAdjust = 3,
                                                                            SpawnRatio = 1.4f,
                                                                            Colour = ColourInfo.GradientVertical(Color4Extensions.FromHex(@"2a2c36"), Color4Extensions.FromHex(@"1a1b21")),
                                                                            RelativeSizeAxes = Axes.Both,
                                                                        },
                                                                    }
                                                                },
