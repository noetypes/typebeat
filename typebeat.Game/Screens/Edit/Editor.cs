...
namespace typebeat.Game.Screens.Edit
{
    ...
    public partial class Editor : OsuScreen, IKeyBindingHandler<GlobalAction>, IKeyBindingHandler<PlatformAction>, IBeatSnapProvider, ISamplePlaybackDisabler, IBeatSyncProvider
    {
        ...
        /// </summary>
        /// <remarks>
        /// Historically, type!beat beatmaps have an assumption of full system latency baked in.
        ...
        /// (e.g. save, export).
        /// </summary>
        public Screens.OnlinePlay.OngoingOperationTracker MutationTracker { get; } = new Screens.OnlinePlay.OngoingOperationTracker();
        ...
        /// </summary>
        /// <remarks>
        /// The state of this bindable is controlled by the compose screen when in <see cref="EditorScreenMode.Compose"/> mode.
        /// </remarks>
        ...
        private void load(OsuConfigManager config)
        {
            ...
            var rulesetInstance = editorBeatmap.BeatmapInfo.Ruleset.CreateInstance();
            canSave = rulesetInstance is ILegacyRuleset || rulesetInstance.CanEncodeToNativeFormat;
        ...
        protected void Clone()
        {
            ...
            // There are a couple of differences from type!beatstable's implementation which will require more work to match:
            ...
            try
            {
                ...
                switch (e.NewValue)
                {
                    ...
                    case EditorScreenMode.Compose:
                        ...
                        var composeRuleset = editorBeatmap.BeatmapInfo.Ruleset;
                        currentScreen = composeRuleset.CreateInstance().CreateEditorComposeScreen()
                                        ?? throw new InvalidOperationException($"{composeRuleset} does not provide an editor compose screen.");
                        break;
        ...
        private IEnumerable<MenuItem> createFileMenuItems()
        {
            ...
            // No legacy-ruleset gate here (unlike lazer): the only ruleset is type!beat and the
            // server accepts exactly its native format.
            if (api.Endpoints.BeatmapSubmissionServiceUrl != null)
            {
